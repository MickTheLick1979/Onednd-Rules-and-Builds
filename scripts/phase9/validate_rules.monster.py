#!/usr/bin/env python3
# Auto-generated Phase 9 validator for: rules.monster
...
def main() -> int:
    ...
    repo = here.parents[2]
    schema = repo / "schema/2024/v1/rules.monster.schema.json".replace("\\\\", "/")
    target = repo / "rules/2024/monster.json".replace("\\\\", "/")
