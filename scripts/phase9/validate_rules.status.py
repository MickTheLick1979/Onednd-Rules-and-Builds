#!/usr/bin/env python3
# Auto-generated Phase 9 validator for: rules.status
...
def main() -> int:
    ...
    repo = here.parents[2]
    schema = repo / "schema/2024/v1/rules.status.schema.json".replace("\\\\", "/")
    target = repo / "rules/2024/status.json".replace("\\\\", "/")
