#!/usr/bin/env python3
# Auto-generated Phase 9 validator for: rules.condition
...
def main() -> int:
    ...
    schema = repo / "schema/2024/v1/rules.condition.schema.json".replace("\\\\", "/")
    target = repo / "rules/2024/condition.json".replace("\\\\", "/")
