#!/usr/bin/env python3
# Auto-generated Phase 9 validator for: rules.backgroundfluff
...
def main() -> int:
    ...
    schema = repo / "schema/2024/v1/rules.backgroundfluff.schema.json".replace("\\\\", "/")
    target = repo / "rules/2024/backgroundfluff.json".replace("\\\\", "/")
